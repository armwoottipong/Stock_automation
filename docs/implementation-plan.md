...
6. **Background module:** segmentation, matte refinement, shadow/reflection policy, edge cleanup, geometry and alpha QC; add white/solid input checks and explicit review for visible text, logos and branding.
