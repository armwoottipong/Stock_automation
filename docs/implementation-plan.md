...
4. **Upscale (in progress):** pixel and creative CLI/workflow code, guided filter, license-gated registries, tests, and pinned Ultimate SD Upscale node are prepared. Model downloads await approval under the supplied requirement; live pixel and creative smoke tests, quality review, and measured 8 GB fallback remain.
