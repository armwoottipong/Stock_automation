...
- Follow `docs/implementation-plan.md` phase order. Phases 1–2 are complete; Phase 3 is awaiting checkpoint download approval and a live model test. Do not treat later phases as implemented.
